...
class LLMGenerationManager:
    ...
    def run_llm_loop(self, gen_batch, envs: List[Any],
        ...
        for step in range(self.config.max_turns):
            ...
            # print('gen_output response str 1:', self.tokenizer.decode(gen_output.batch['responses'][0]))
            # print('gen_output response str 2:', self.tokenizer.decode(gen_output.batch['responses'][1]))
            # print('gen_output response str 3:', self.tokenizer.decode(gen_output.batch['responses'][2]))
            # print('gen_output response str 4:', self.tokenizer.decode(gen_output.batch['responses'][3]))
