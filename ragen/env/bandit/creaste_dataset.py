...
def main():
    ...
    parser.add_argument("--train_size", type=int, default=300, help="Number of training instances (default: 300).")
    parser.add_argument("--test_size", type=int, default=10, help="Number of test instances (default: 10).")
    ...
    from ragen.env.bandit import BanditEnv
